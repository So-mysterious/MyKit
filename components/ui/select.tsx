/**
 * [性质]: [组件] 选择器组件
 * [Input]: Radix UI Select
 * [Output]: Select, SelectItem, etc.
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-2 pr-2 text-sm outline-none focus:bg-gray-100 focus:text-gray-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
    )}
    {...props}
  >
    {/* Modified: Remove absolute positioning of check, put it at the end or handle differently to avoid padding */}
